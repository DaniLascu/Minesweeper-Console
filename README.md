...
```
2. **Intterupts**: as I have already shown in the **Software design** section, all three pushbuttons that the project uses, are debounced using intterupts.
3. **ADC**: as I have already shown in the **Software design** section, the joystick makes use of the ADC function of the ESP32 through the **analogRead()** function.
